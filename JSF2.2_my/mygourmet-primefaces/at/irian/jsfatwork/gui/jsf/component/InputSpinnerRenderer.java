...
@ResourceDependencies({ @ResourceDependency(library = "mygourmet", name = "inputSpinner.js", target = "head"), @ResourceDependency(library = "mygourmet", name = "components.css") })
...
public class InputSpinnerRenderer extends Renderer {
	...
	@Override
	public Object getConvertedValue(FacesContext ctx, UIComponent component, Object submittedValue) throws ConverterException {
