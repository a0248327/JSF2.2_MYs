	...
	public void validate(FacesContext ctx, UIComponent component, Object value) throws ValidatorException {
		...
		if (date != null) {
			...
			if (date.after(new Date())) {
				FacesMessage msg = GuiUtil.getFacesMessage(ctx, FacesMessage.SEVERITY_ERROR, "validateBirthday.MAXIMUM");
			...
			if (date.before(cal.getTime())) {
				FacesMessage msg = GuiUtil.getFacesMessage(ctx, FacesMessage.SEVERITY_ERROR, "validateBirthday.MINIMUM");
				throw new ValidatorException(msg);
			}
		}
	}
