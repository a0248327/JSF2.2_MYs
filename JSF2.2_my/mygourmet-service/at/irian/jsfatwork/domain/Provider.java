...
public class Provider extends AbstractBaseEntity {
	...
	@JoinTable(name = "PROVIDER_CATEGORY", joinColumns = @JoinColumn(name = "PROVIDER_ID", referencedColumnName = "ID"), inverseJoinColumns = @JoinColumn(name = "CATEGORY_ID", referencedColumnName = "ID"))
